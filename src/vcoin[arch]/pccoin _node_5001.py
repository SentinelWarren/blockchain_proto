...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = "Warren", amount = 1)
...
def add_transaction():
    ...
    if not all(key in jsn for key in transaction_keys): return "Some elements on the transaction are missing", 400
